...
<body class="fix-header fix-sidebar">
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                <div class="navbar-header">
                    <a class="navbar-brand" href="dashboard.php">
                        ...
                        <span><img src="images/lo.png" alt="homepage" class="dark-logo" /></span>
                    </a>
                </div>
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted  " href="#" data-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false"><img src="images/bookingSystem/10.jpg"
    ...
    <tr>
        ...
        <th>Reg-Date</th>
        <th>Action</th>
        <th>Rating</th> <!-- Add this column -->
    </tr>
</thead>
<tbody>
    <?php
    $sql = "SELECT users.*, users_orders.*, ratings.rating 
            FROM users 
            INNER JOIN users_orders ON users.u_id = users_orders.u_id 
            LEFT JOIN ratings ON users_orders.o_id = ratings.o_id";
    ...
    if (!mysqli_num_rows($query) > 0) {
        ...
        while ($rows = mysqli_fetch_array($query)) {
            ...
            <tr>
                ...
                <td>
                    <!-- Display the rating -->
                    <?php echo isset($rows['rating']) ? $rows['rating'] : 'No Rating'; ?>
                </td>
            </tr>
            <?php
        }
